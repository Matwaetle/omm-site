...
+ 6 program(s) not installed`,
    ...
    trouble: [
      ...
      { see: "git clone failed.", source: "install.ps1:529" },
      {
  ...
  macos: {
    ...
    trouble: [
      ...
      { see: "error: externally-managed-environment", source: "install.sh:327-336" },
      {
      ...
      { see: "zsh: command not found: omm", source: "install.sh:508" },
      {
  ...
  linux: {
    ...
    before: {
      requirements: [
        ...
        { label: "Fedora, Arch, openSUSE, Alpine", links: null },
    ...
    trouble: [
      ...
      { see: "bash: omm: command not found", source: "install.sh:508" },
      {
        see: "Refusing non-absolute OMM_HOME: models/omm",
        source: "install.sh:11 and install.sh:14",
      },
